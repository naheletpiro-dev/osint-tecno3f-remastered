  ...
  return (
    <div className="dashboard-grid">
      ...
      <div className="saas-card col-6" style={{ padding: '24px', borderTop: '4px solid #60a5fa' }}>
        ...
        <h3 style={{ fontSize: '1.4rem', fontWeight: 800, marginTop: '2px', color: '#fff' }}>{compA}</h3>
      ...
      <div className="saas-card col-6" style={{ padding: '24px', borderTop: '4px solid #2dd4bf' }}>
        ...
        <h3 style={{ fontSize: '1.4rem', fontWeight: 800, marginTop: '2px', color: '#fff' }}>{compB}</h3>
      ...
      <div className="saas-card col-12" style={{ padding: '26px' }}>
        <h3 style={{ fontSize: '1.2rem', marginBottom: '20px', fontWeight: 800, color: '#f8fafc', display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.92rem' }}>
          ...
          <tbody>
            ...
            <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
              ...
              <td style={{ padding: '14px', fontWeight: 800, color: finA.riskColor || '#10b981' }}>{finA.creditScore || 75} / 100 ({finA.riskLevel || 'BAJO'})</td>
              <td style={{ padding: '14px', fontWeight: 800, color: finB.riskColor || '#10b981' }}>{finB.creditScore || 75} / 100 ({finB.riskLevel || 'BAJO'})</td>
            </tr>

            <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
              <td style={{ padding: '14px', fontWeight: 700, color: 'var(--text-secondary)' }}>Capacidad Licitatoria ($ ARS)</td>
              <td style={{ padding: '14px', fontWeight: 800, color: '#34d399', fontFamily: 'var(--font-mono)' }}>{capA.estimatedBiddingCapacityARS || '$150M ARS'}</td>
              <td style={{ padding: '14px', fontWeight: 800, color: '#34d399', fontFamily: 'var(--font-mono)' }}>{capB.estimatedBiddingCapacityARS || '$150M ARS'}</td>
            </tr>
            ...
            <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
              ...
              <td style={{ padding: '14px', fontWeight: 600, color: '#34d399' }}>{finA.taxProfile?.stateContractorStatus || 'Habilitado'}</td>
              <td style={{ padding: '14px', fontWeight: 600, color: '#34d399' }}>{finB.taxProfile?.stateContractorStatus || 'Habilitado'}</td>
            </tr>
