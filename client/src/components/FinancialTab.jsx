      ...
      {bcra && (
        <div className="saas-card col-12" style={{ padding: '24px', background: 'rgba(15, 23, 42, 0.6)', border: `1px solid ${bcra.situacionColor || 'rgba(37, 99, 235, 0.3)'}` }}>
          ...
          {bcra.entidadesCreditoras?.length > 0 ? (
                    ...
                    {bcra.entidadesCreditoras.map((ent, idx) => (
                      <tr key={idx} style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                        ...
                        <td style={{ padding: '10px 12px' }}>
                          <span style={{ color: ent.situacionInfo?.color || '#34d399', fontWeight: 700 }}>
            ...
            <div style={{ background: 'rgba(16, 185, 129, 0.08)', padding: '12px 16px', borderRadius: '10px', border: '1px solid rgba(16, 185, 129, 0.2)', fontSize: '0.86rem', color: '#34d399', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          {bcra.trendAnalysis && bcra.history24Months?.length > 0 && (
            <div style={{ marginTop: '20px', background: 'rgba(0,0,0,0.3)', padding: '18px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.08)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px', marginBottom: '12px' }}>
                <h4 style={{ fontSize: '0.98rem', fontWeight: 800, color: '#f8fafc', margin: 0, display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <tbody>
                    {bcra.history24Months.slice(0, 12).map((h, idx) => (
                      <tr key={idx} style={{ borderBottom: '1px solid rgba(255,255,255,0.03)' }}>
                        <td style={{ padding: '6px 8px', textAlign: 'left', fontWeight: 700, color: '#f8fafc' }}>{h.periodo}</td>
                        <td style={{ padding: '6px 8px' }}>
                          <span style={{
                            ...
                            padding: '2px 8px',
                            borderRadius: '6px',
                            background: `${h.situacionInfo?.color || '#10b981'}20`,
                            color: h.situacionInfo?.color || '#10b981'
                          }}>
