    ...
    <footer style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <div>
          ...
          <span style={{ marginLeft: '8px', color: '#64748b' }}>| Plataforma de Inteligencia Comercial</span>
        </div>
      </div>

      <div style={{ textAlign: 'right', fontWeight: 600 }}>
        © {currentYear} OSINT Tecno3F. <strong style={{ color: '#f8fafc' }}>Desarrollado por Tecno3F</strong>. Todos los derechos reservados.
      </div>
    </footer>
  );
}
