    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', position: 'relative' }}>
      ...
      {user ? (
        <div style={{ position: 'relative' }}>
          ...
          >
            <div style={{ width: '28px', height: '28px', borderRadius: '50%', background: 'linear-gradient(135deg, #4285F4, #34A853)', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, fontSize: '0.85rem' }}>
              {user.name.charAt(0)}
            </div>
