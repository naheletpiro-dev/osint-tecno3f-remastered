        ...
        <div style={{ position: 'relative' }}>
          ...
          {openDropdown === 'tools' && (
            <div style={{
              ...
              <button
                style={{ width: '100%', padding: '10px 14px', background: 'none', border: 'none', color: 'var(--text-primary)', fontSize: '0.88rem', display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer', borderRadius: '8px', textAlign: 'left' }}
          ...
          <div style={{ position: 'relative' }}>
            ...
            {openDropdown === 'export' && (
              <div style={{
                ...
                <button
                  style={{ width: '100%', padding: '10px 14px', background: 'none', border: 'none', color: 'var(--accent-emerald)', fontSize: '0.88rem', display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer', borderRadius: '8px', textAlign: 'left' }}
        ...
        <div style={{ position: 'relative' }}>
          ...
          {openDropdown === 'user' && (
            <div style={{
              ...
              >
                {theme === 'dark' ? <Sun size={15} style={{ color: 'var(--accent-amber)' }} /> : <Moon size={15} style={{ color: '#a78bfa' }} />}
              ...
              {user ? (
                ...
                <button
                  style={{ width: '100%', padding: '10px 14px', background: 'none', border: 'none', color: 'var(--accent-emerald)', fontSize: '0.88rem', display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer', borderRadius: '8px', textAlign: 'left', fontWeight: 600 }}
