      ...
      <div className="saas-card col-8" style={{ padding: '28px' }}>
        ...
        {newsItems.length > 0 ? (
          ...
          <div style={{ color: 'var(--text-muted)', padding: '36px 24px', textAlign: 'center', background: 'rgba(255,255,255,0.02)', borderRadius: '12px', border: '1px dashed var(--border-subtle)' }}>
            <Newspaper size={36} style={{ color: 'var(--text-muted)', marginBottom: '12px' }} />
            <div style={{ fontSize: '0.98rem', fontWeight: 700, color: 'var(--text-secondary)' }}>Sin artículos periodísticos verificados para {companyName}</div>
            <div style={{ fontSize: '0.82rem', color: 'var(--text-muted)', marginTop: '6px', maxWidth: '420px', margin: '6px auto 0' }}>
