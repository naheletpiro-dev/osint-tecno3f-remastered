...
export default function OsintNetworkGraph({ report, onTabChange }) {
  ...
  const nodes = {
    ...
    bcra: {
      ...
      color: bcra.situacionColor || '#10b981',
      tabKey: 'financial',
  ...
  return (
    <div className="saas-card col-12" style={{ padding: '26px', background: '#0b0f17', border: '1px solid #1e293b' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr', gap: '24px', alignItems: 'center' }}>
        ...
        <div style={{ position: 'relative', width: '100%', height: '340px', background: '#0f172a', borderRadius: '16px', border: '1px solid #1e293b', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
          <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none' }}>
            {/* Connection Lines from Center (200, 170) to Outer Nodes */}
            <line x1="50%" y1="50%" x2="18%" y2="20%" stroke="#334155" strokeWidth="2" strokeDasharray="4,4" />
            <line x1="50%" y1="50%" x2="50%" y2="15%" stroke="#334155" strokeWidth="2" strokeDasharray="4,4" />
            <line x1="50%" y1="50%" x2="82%" y2="20%" stroke="#334155" strokeWidth="2" strokeDasharray="4,4" />
            <line x1="50%" y1="50%" x2="88%" y2="50%" stroke="#334155" strokeWidth="2" strokeDasharray="4,4" />
            <line x1="50%" y1="50%" x2="82%" y2="80%" stroke="#334155" strokeWidth="2" strokeDasharray="4,4" />
            <line x1="50%" y1="50%" x2="50%" y2="85%" stroke="#334155" strokeWidth="2" strokeDasharray="4,4" />
            <line x1="50%" y1="50%" x2="18%" y2="80%" stroke="#334155" strokeWidth="2" strokeDasharray="4,4" />
          </svg>
          ...
          <div
            ...
            style={{
              ...
              zIndex: 10,
              cursor: 'pointer',
              background: activeNode === 'center' ? '#2563eb' : '#1e293b',
          ...
          <div
            ...
            style={{
              ...
              transform: 'translate(-50%, -50%)',
              cursor: 'pointer',
              background: activeNode === 'afip' ? '#065f46' : '#1e293b',
          ...
          <div
            ...
            style={{
              ...
              transform: 'translate(-50%, -50%)',
              cursor: 'pointer',
              background: activeNode === 'bcra' ? '#065f46' : '#1e293b',
          ...
          <div
            ...
            style={{
              ...
              transform: 'translate(-50%, -50%)',
              cursor: 'pointer',
              background: activeNode === 'inpi' ? '#5b21b6' : '#1e293b',
          ...
          <div
            ...
            style={{
              ...
              transform: 'translate(-50%, -50%)',
              cursor: 'pointer',
              background: activeNode === 'contracts' ? '#0284c7' : '#1e293b',
          ...
          <div
            ...
            style={{
              ...
              transform: 'translate(-50%, -50%)',
              cursor: 'pointer',
              background: activeNode === 'trade' ? '#9a3412' : '#1e293b',
          ...
          <div
            ...
            style={{
              ...
              transform: 'translate(-50%, -50%)',
              cursor: 'pointer',
              background: activeNode === 'pyme' ? '#4c1d95' : '#1e293b',
          ...
          <div
            ...
            style={{
              ...
              transform: 'translate(-50%, -50%)',
              cursor: 'pointer',
              background: activeNode === 'web' ? '#0e7490' : '#1e293b',
        ...
        <div style={{ background: '#1e293b', border: `1px solid ${selected.color}`, borderRadius: '16px', padding: '22px' }}>
          <div style={{ fontSize: '0.74rem', color: selected.color, fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.04em' }}>
            {selected.badge}
          </div>
          <h4 style={{ fontSize: '1.25rem', fontWeight: 800, color: '#f8fafc', margin: '4px 0 2px 0' }}>
            {selected.title}
          </h4>
          ...
          <p style={{ fontSize: '0.88rem', color: '#94a3b8', lineHeight: '1.5', background: '#0f172a', padding: '12px 14px', borderRadius: '10px', border: '1px solid #334155' }}>
            {selected.details}
          </p>
