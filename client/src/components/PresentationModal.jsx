...
export default function PresentationModal({ report, onClose }) {
  ...
  const slides = [
      ...
      content: (
        <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '24px', alignItems: 'stretch' }}>
          <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <span style={{ fontSize: '0.78rem', color: '#94a3b8', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                INFORME DE INTELIGENCIA CORPORATIVA OSINT
              </span>
              <h1 style={{ fontSize: '2.4rem', fontWeight: 900, color: '#f8fafc', margin: '8px 0 14px 0', lineHeight: 1.1 }}>
                {companyName}
              </h1>

              <div style={{ background: '#1e293b', padding: '14px 18px', borderRadius: '12px', border: '1px solid #334155', marginBottom: '16px' }}>
                <div style={{ fontSize: '0.74rem', color: '#94a3b8', fontWeight: 700, textTransform: 'uppercase' }}>SECTOR DE ACTIVIDAD Y RUBRO</div>
          ...
          <div style={{ background: '#1e293b', border: `1px solid ${bcra.situacionColor || '#334155'}`, borderRadius: '18px', padding: '24px', textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <div style={{ fontSize: '0.78rem', color: '#94a3b8', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '10px' }}>
              Central de Deudores BCRA
            </div>
            <div style={{ fontSize: '2.2rem', fontWeight: 900, color: bcra.situacionColor || '#34d399' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginTop: '20px', paddingTop: '16px', borderTop: '1px solid #334155' }}>
              <div>
                <div style={{ fontSize: '0.72rem', color: '#94a3b8', fontWeight: 700 }}>CHEQUES RECHAZADOS</div>
                <div style={{ fontSize: '1.2rem', fontWeight: 800, color: (bcra.chequesRechazados?.totalCount || 0) > 0 ? '#fb7185' : '#34d399', marginTop: '2px' }}>
                  {bcra.chequesRechazados?.totalCount || 0}
                </div>
              </div>
              <div>
                <div style={{ fontSize: '0.72rem', color: '#94a3b8', fontWeight: 700 }}>SCORING FINANCIERO</div>
    ...
    // Slide 2: Commercial & Web Profile
    {
      ...
      content: (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', maxHeight: '420px', overflowY: 'auto' }}>
          <div style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: '16px', padding: '22px' }}>
            ...
            {Array.isArray(scrapedData.products) && scrapedData.products.length > 0 ? (
              <ul style={{ display: 'flex', flexDirection: 'column', gap: '8px', listStyle: 'none', padding: 0 }}>
                {scrapedData.products.map((p, idx) => (
                  <li key={idx} style={{ background: '#0f172a', padding: '10px 14px', borderRadius: '8px', border: '1px solid #334155', color: '#cbd5e1', fontSize: '0.9rem', fontWeight: 600 }}>
                    • {p}
                  </li>
                ))}
              </ul>
            ) : (
              <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>Provisión de insumos y soluciones corporativas para el sector industrial.</p>
            )}
          </div>
          ...
          <div style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: '16px', padding: '22px' }}>
            ...
            {Array.isArray(scrapedData.services) && scrapedData.services.length > 0 ? (
              ...
              <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>Asistencia técnica, ingeniería y provisión especializada.</p>
            )}
          </div>
        </div>
      )
      ...
      content: (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '18px' }}>
          <div style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: '14px', padding: '20px' }}>
            ...
            <p style={{ color: '#f8fafc', fontSize: '0.92rem', marginTop: '6px', lineHeight: '1.5' }}>
          ...
          <div style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: '14px', padding: '20px' }}>
            <div style={{ fontSize: '0.76rem', color: '#34d399', fontWeight: 800, textTransform: 'uppercase' }}>3. ¿Cómo genera ingresos?</div>
            <p style={{ color: '#f8fafc', fontSize: '0.92rem', marginTop: '6px', lineHeight: '1.5' }}>
          ...
          <div style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: '14px', padding: '20px' }}>
            <div style={{ fontSize: '0.76rem', color: '#fbbf24', fontWeight: 800, textTransform: 'uppercase' }}>4. Activo Crítico Estratégico</div>
            <p style={{ color: '#f8fafc', fontSize: '0.92rem', marginTop: '6px', lineHeight: '1.5' }}>
      ...
      content: (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', maxHeight: '420px', overflowY: 'auto' }}>
          <div style={{ background: 'rgba(16, 185, 129, 0.1)', border: '1px solid rgba(16, 185, 129, 0.3)', borderRadius: '14px', padding: '18px' }}>
            <h4 style={{ color: '#34d399', fontSize: '1rem', fontWeight: 800, marginBottom: '10px' }}>💪 Fortalezas</h4>
          ...
          <div style={{ background: 'rgba(245, 158, 11, 0.1)', border: '1px solid rgba(245, 158, 11, 0.3)', borderRadius: '14px', padding: '18px' }}>
            <h4 style={{ color: '#fbbf24', fontSize: '1rem', fontWeight: 800, marginBottom: '10px' }}>⚠️ Debilidades</h4>
            <ul style={{ paddingLeft: '18px', color: '#cbd5e1', fontSize: '0.86rem', display: 'flex', flexDirection: 'column', gap: '6px' }}>
    ...
    // Slide 5: Digital Transformation & Kits 4.0
    {
      ...
      content: (
        <div style={{ display: 'grid', gridTemplateColumns: '0.8fr 1.2fr', gap: '20px', alignItems: 'stretch' }}>
          <div style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: '18px', padding: '24px', textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <div style={{ fontSize: '0.78rem', color: '#94a3b8', fontWeight: 800, textTransform: 'uppercase' }}>Índice de Madurez Digital</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            {kits.primary && (
              <div style={{ background: '#1e293b', border: '1px solid rgba(56, 189, 248, 0.4)', padding: '18px', borderRadius: '14px' }}>
                ...
                <div style={{ fontSize: '0.78rem', color: '#34d399', fontWeight: 700, marginTop: '8px' }}>
            ...
            {kits.secondary && (
              <div style={{ background: '#1e293b', border: '1px solid rgba(168, 85, 247, 0.4)', padding: '18px', borderRadius: '14px' }}>
          ...
          <div style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: '16px', padding: '22px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
              <div>
                ...
                <div style={{ fontSize: '0.86rem', color: contracts.isRealData ? '#34d399' : '#94a3b8', marginTop: '2px', fontWeight: 600 }}>
                  {contracts.supplierRegistryStatus || 'Dato no disponible en registros públicos'}
                </div>
              </div>
              <div style={{ textAlign: 'right' }}>
                <div style={{ fontSize: '0.74rem', color: '#94a3b8', textTransform: 'uppercase', fontWeight: 700 }}>Total Adjudicado</div>
            ...
            {Array.isArray(contracts.contracts) && contracts.contracts.length > 0 ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '12px' }}>
                {contracts.contracts.map((c, idx) => (
                  <div key={idx} style={{ background: '#0f172a', padding: '12px 16px', borderRadius: '8px', border: '1px solid #334155', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div>
                      <div style={{ fontSize: '0.9rem', fontWeight: 700, color: '#f8fafc' }}>{c.organism}</div>
                      <div style={{ fontSize: '0.82rem', color: '#94a3b8', marginTop: '2px' }}>{c.description}</div>
                    </div>
                    <span style={{ fontSize: '0.85rem', fontWeight: 800, color: '#34d399' }}>{c.amount}</span>
                  </div>
                ))}
              </div>
            ) : (
              <p style={{ color: '#94a3b8', fontSize: '0.88rem' }}>Sin contrataciones ni licitaciones públicas registradas.</p>
            )}
          </div>
        </div>
      )
    ...
    // Slide 7: Complete Financial & BCRA Profile
    {
      ...
      content: (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
          <div style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: '14px', padding: '20px', textAlign: 'center' }}>
            <div style={{ fontSize: '0.76rem', color: '#94a3b8', fontWeight: 700 }}>SITUACIÓN BCRA</div>
            <div style={{ fontSize: '1.8rem', fontWeight: 900, color: bcra.situacionColor || '#34d399', marginTop: '6px' }}>
          ...
          <div style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: '14px', padding: '20px', textAlign: 'center' }}>
            <div style={{ fontSize: '0.76rem', color: '#94a3b8', fontWeight: 700 }}>CAPACIDAD LICITATORIA ESTIMADA</div>
          ...
          <div style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: '14px', padding: '20px', textAlign: 'center' }}>
            <div style={{ fontSize: '0.76rem', color: '#94a3b8', fontWeight: 700 }}>LÍMITE CREDITICIO SUGERIDO</div>
            <div style={{ fontSize: '1.25rem', fontWeight: 800, color: '#34d399', marginTop: '6px' }}>
    ...
    // Slide 8: Support Plan & Program Actions
    {
      ...
      content: (
        <div style={{ background: '#1e293b', border: '1px solid #334155', borderRadius: '18px', padding: '24px', maxHeight: '420px', overflowY: 'auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {Array.isArray(support.recommendations) && support.recommendations.length > 0 ? (
              support.recommendations.map((rec, idx) => (
                <div key={idx} style={{ background: '#0f172a', padding: '14px 18px', borderRadius: '10px', border: '1px solid #334155' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '24px 0' }}>
        <div style={{ marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '14px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.9rem', color: '#94a3b8', marginTop: '2px', fontWeight: 600 }}>
