  ...
  return (
    <div className="dashboard-grid">
      ...
      <div className="saas-card col-12" style={{ padding: '26px', background: 'linear-gradient(135deg, rgba(6, 182, 212, 0.08), rgba(37, 99, 235, 0.05))', border: '1px solid rgba(37, 99, 235, 0.3)' }}>
        ...
        <div style={{ background: isRealData ? 'rgba(16, 185, 129, 0.08)' : 'rgba(255, 255, 255, 0.03)', border: `1px solid ${isRealData ? 'rgba(16, 185, 129, 0.25)' : 'var(--border-subtle)'}`, padding: '12px 16px', borderRadius: '8px', marginTop: '18px', fontSize: '0.88rem', color: isRealData ? '#34d399' : '#94a3b8', fontWeight: 600 }}>
      ...
      <div className="saas-card col-12" style={{ padding: '26px' }}>
        ...
        {contracts.length > 0 ? (
          ...
          <div style={{ color: 'var(--text-muted)', padding: '36px 24px', textAlign: 'center', background: 'rgba(255,255,255,0.02)', borderRadius: '12px', border: '1px dashed var(--border-subtle)' }}>
            <Landmark size={36} style={{ color: '#64748b', marginBottom: '12px' }} />
            <div style={{ fontSize: '0.98rem', fontWeight: 700, color: '#94a3b8' }}>Dato no disponible / Sin licitaciones estatales registradas para {companyName}</div>
            <div style={{ fontSize: '0.82rem', color: '#64748b', marginTop: '6px', maxWidth: '440px', margin: '6px auto 0' }}>
