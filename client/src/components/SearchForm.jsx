      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '20px', borderBottom: '1px solid var(--border-subtle)', paddingBottom: '14px' }}>
        <button
          ...
          style={{
            ...
            color: !isCompareMode ? 'var(--text-primary)' : 'var(--text-secondary)',
            padding: '8px 18px',
            borderRadius: '12px',
            fontWeight: 700,
            fontSize: '0.88rem',
              ...
              <label className="field-label" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                {isCuitFilled && (
                  <span style={{
                    ...
                    color: isCuitValid ? 'var(--accent-emerald)' : 'var(--accent-rose)',
                    border: `1px solid ${isCuitValid ? 'var(--accent-emerald)' : 'var(--accent-rose)'}`
                  }}>
