...
export async function downloadFullPdfReport(report) {
  ...
  const htmlContent = `
    <div style="font-family: Arial, sans-serif; color: #0f172a; padding: 14px 16px 16px 16px; background: #ffffff; line-height: 1.45; font-size: 11px; width: 750px; box-sizing: border-box;">
      ...
      <div className="pdf-section" style="page-break-inside: avoid !important; break-inside: avoid-page !important; border-bottom: 3px solid #2563eb; padding: 12px 16px; margin-bottom: 16px; display: flex; justify-content: space-between; align-items: center; background: #f8fafc; border-radius: 8px; border: 1px solid #cbd5e1;">
      ...
      <div className="pdf-section" style="page-break-inside: avoid !important; break-inside: avoid-page !important; margin-bottom: 16px; background: #0f172a; border: 2px solid #334155; border-radius: 10px; padding: 14px; color: #ffffff;">
      ...
      <div className="pdf-section" style="page-break-inside: avoid !important; break-inside: avoid-page !important; margin-bottom: 16px; background: #f8fafc; border: 1px solid #cbd5e1; border-radius: 8px; padding: 12px;">
        ...
        <table style="width: 100%; font-size: 10px; border-collapse: collapse;" border="1" borderColor="#cbd5e1" cellPadding="4">
          <tr style="background: #e2e8f0; page-break-inside: avoid !important; break-inside: avoid-page !important;">
      ...
      <div className="pdf-section" style="page-break-inside: avoid !important; break-inside: avoid-page !important; margin-bottom: 16px;">
        <h2 style="font-size: 12px; color: #1e3a8a; margin-top: 0; border-bottom: 2px solid #cbd5e1; padding-bottom: 4px; font-weight: 800;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 10px;" border="1" borderColor="#cbd5e1" cellPadding="4">
          <tr style="background: #1e293b; color: #ffffff; page-break-inside: avoid !important; break-inside: avoid-page !important;">
            <th style="width: 25%; text-align: left;">Dimensión Comercial</th>
            <th style="text-align: left;">Detalle Verificado</th>
          </tr>
          <tr style="background: #ffffff; page-break-inside: avoid !important; break-inside: avoid-page !important;">
          ...
          <tr style="background: #f8fafc; page-break-inside: avoid !important; break-inside: avoid-page !important;">
      ...
      <div className="pdf-section" style="page-break-inside: avoid !important; break-inside: avoid-page !important; margin-bottom: 16px; background: #f1f5f9; border: 1px solid #cbd5e1; border-radius: 8px; padding: 12px;">
        <h2 style="font-size: 12px; color: #1e3a8a; margin-top: 0; border-bottom: 2px solid #cbd5e1; padding-bottom: 4px; font-weight: 800;">
      ...
      <div className="pdf-section" style="page-break-inside: avoid !important; break-inside: avoid-page !important; margin-bottom: 16px;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 10px;" border="1" borderColor="#cbd5e1" cellPadding="5">
          <tr style="background: #f1f5f9; page-break-inside: avoid !important; break-inside: avoid-page !important;">
          ...
          <tr style="background: #ffffff; vertical-align: top; page-break-inside: avoid !important; break-inside: avoid-page !important;">
      ...
      <div className="pdf-section" style="page-break-inside: avoid !important; break-inside: avoid-page !important; margin-bottom: 16px; background: #f0f9ff; border: 1px solid #bae6fd; border-radius: 8px; padding: 12px;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 10px;" border="1" borderColor="#cbd5e1" cellPadding="4">
          <tr style="background: #e0f2fe; page-break-inside: avoid !important; break-inside: avoid-page !important;">
      ...
      <div className="pdf-section" style="page-break-inside: avoid !important; break-inside: avoid-page !important; margin-bottom: 16px; background: #faf5ff; border: 1px solid #e9d5ff; border-radius: 8px; padding: 12px;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 10px;" border="1" borderColor="#e9d5ff" cellPadding="4">
          <tr style="background: #f3e8ff; page-break-inside: avoid !important; break-inside: avoid-page !important;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 10px;" border="1" borderColor="#cbd5e1" cellPadding="4">
          ...
          ${(inpi.trademarks && inpi.trademarks.length > 0) ? inpi.trademarks.map(t => `
            <tr style="background: #ffffff; page-break-inside: avoid !important; break-inside: avoid-page !important;">
              ...
              <td style="text-align: center; color: ${(t.status && t.status.toLowerCase().includes('concedida')) ? '#047857' : '#0f172a'};">${t.status || 'Registrada'}</td>
            </tr>
          `).join('') : `
            <tr style="page-break-inside: avoid !important; break-inside: avoid-page !important;">
      ...
      <div className="pdf-section" style="page-break-inside: avoid !important; break-inside: avoid-page !important; margin-bottom: 16px; background: #fff1f2; border: 1px solid #fecdd3; border-radius: 8px; padding: 12px;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 10px;" border="1" borderColor="#fecdd3" cellPadding="4">
          <tr style="background: #ffe4e6; page-break-inside: avoid !important; break-inside: avoid-page !important;">
      ...
      <div className="pdf-section" style="page-break-inside: avoid !important; break-inside: avoid-page !important; margin-bottom: 16px; background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; padding: 12px;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 10px;" border="1" borderColor="#bbf7d0" cellPadding="4">
          <tr style="background: #dcfce7; page-break-inside: avoid !important; break-inside: avoid-page !important;">
      ...
      <div className="pdf-section" style="page-break-inside: avoid !important; break-inside: avoid-page !important; margin-bottom: 16px; margin-top: 14px;">
      ...
      <div className="pdf-section" style="page-break-inside: avoid !important; break-inside: avoid-page !important; text-align: center; font-size: 8.5px; color: #64748b; border-top: 2px solid #cbd5e1; padding-top: 6px; margin-top: 12px;">
  ...
  // Create temporary container directly appended to body
  const tempContainer = document.createElement('div');
  tempContainer.id = 'pdf-export-temp-node';
  ...
  const options = {
    ...
    pagebreak: {
      ...
      avoid: ['.pdf-section', 'tr', 'table', 'div']
    }
  };
  ...
  try {
    ...
    const el = document.getElementById('pdf-export-temp-node');
