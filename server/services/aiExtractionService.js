...
async function callGroqFocused(apiKey, prompt, mimeType) {
  try {
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        model: 'openai/gpt-oss-20b', // Fast, capable model for JSON extraction
...
Devuelve UN SOLO JSON con las siguientes llaves exactas:
{
  ...
  "strengths": ["Descripción detallada de 2 a 3 oraciones explicando una fortaleza interna clave (recursos, capacidades, ventajas competitivas).", "Otra fortaleza detallada explicada en profundidad."],
  "weaknesses": ["Descripción detallada de 2 a 3 oraciones sobre una debilidad interna, vulnerabilidad o área de mejora estructurada."],
  "opportunities": ["Descripción detallada de 2 a 3 oraciones sobre una oportunidad del entorno externo (nuevos mercados, tendencias, cambios regulatorios)."],
  "threats": ["Descripción detallada de 2 a 3 oraciones sobre una amenaza externa crítica (competidores, riesgos económicos o barreras de entrada)."],
