...
export function analyzeFinancials(companyName, scrapedData = {}, searchResults = {}, bcraData = null) {
  ...
  const defaultBcraDetails = {
    ...
    hasCheques: false,
    situacionMax: 1,
    situacionLabel: 'Sin datos bancarios verificados en BCRA',
    situacionDescription: 'Se requiere CUIT verificado en ARCA/AFIP para la consulta oficial en Central de Deudores BCRA.',
