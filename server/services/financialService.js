...
export function analyzeFinancials(companyName, scrapedData = {}, searchResults = {}, bcraData = null) {
  ...
  const cuitFormatted = (bcraData && bcraData.cuit && bcraData.cuit !== 'N/D') ? bcraData.cuit : 'N/D (No verificado en ARCA/AFIP)';
  ...
  const defaultBcraDetails = {
    ...
    hasCheques: false,
    situacionMax: 1,
    situacionLabel: 'Sin datos bancarios verificados (Estimación Heurística)',
    situacionDescription: 'Se requiere CUIT verificado para consulta oficial. Score estimado mediante reglas heurísticas OSINT.',
    situacionColor: '#f59e0b',
    periodoMasReciente: 'Simulación',
    entidadesCreditoras: [],
    ...
    apiSource: 'Modelo Algorítmico OSINT (SIMULADOR ESTIMADO)'
  };
  ...
  return {
    ...
    biddingCapacity: {
      ...
      biddingEligibilityNotice: `Capacidad estimada de hasta ${biddingCapacityFormatted} basada en heurística simulada.`
    },
